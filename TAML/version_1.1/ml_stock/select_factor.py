...
def array_process(array):
	...
	return array	
def get_factors(high,low,close,volume,BBANDS=False,DEMA=False,EMA=False,HT_TRENDLINE=False,KAMA=False,MA=False,MAMA=False,MAVP=False,MIDPOINT=False,MIDPRICE=False,SAR=False,SAREXT=False,SMA=False,T3=False,TEMA=False,TRIMA=False,WMA=False,
	AD=False,ADOSC=False,OBV=False,HT_DCPERIOD=False,HT_DCPHASE=False,HT_PHASOR=False,HT_SINE=False,HT_TRENDMODE=False,AVGPRICE=False,MEDPRICE=False,TYPPRICE=False,WCLPRICE=False,ATR=False,NATR=False,TRANGE=False,
	ADX=False,ADXR=False,APO=False,AROON=False,AROONOSC=False,BOP=False,CCI=False,CMO=False,DX=False,MACD=False,ivergence=False,MACDEXT=False,MACDFIX=False,MFI=False,MINUS_DI=False,MINUS_DM=False,MOM=False,PLUS_DI=False,PLUS_DM=False,PPO=False,ROC=False,ROCP=False,ROCR=False,ROCR100=False,RSI=False,STOCH=False,STOCHF=False,STOCHRSI=False,TRIX=False,ULTOSC=False,WILLR=False):
